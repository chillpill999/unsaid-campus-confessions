...
export const MOCK_CONFESSIONS: PublicConfession[] = [
  ...
  },
  {
    id: 'conf-5',
    public_code: 'CF5P9Q',
    content: 'Does anyone actually understand the homework assignment for Data Structures or are we all just pretending during lab hours?',
...
export const MOCK_REVEALED_IDENTITIES: Record<string, RevealedIdentityPayload> = {
  'CF7K2P': {
    ...
    google_email: 'alex.smith.demo@lnjpit.ac.in',
...
export const MOCK_INBOX_CONVERSATIONS: AnonymousConversation[] = [
  {
    ...
    peer_label: 'Anonymous (Canteen Girl?)',
...
export const MOCK_CONVERSATION_MESSAGES: Record<string, AnonymousMessage[]> = {
  'conv-1': [
    ...
    },
    {
      id: 'msg-2',
      conversation_id: 'conv-1',
      sender_label: 'Anonymous (Canteen Girl?)',
