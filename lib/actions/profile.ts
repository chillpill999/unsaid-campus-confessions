...
export async function getMyProfileSummary(): Promise<{
  ...
  try {
    ...
    try {
      ...
      // Fallback to standard server client if admin service role is unavailable
    }
    ...
    return {
      profile: profileRow
        ? {
            ...
            batch: profileRow.batch || '2026',
            department: profileRow.department || 'Computer Science & Engineering (CSE)',
