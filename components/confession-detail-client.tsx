...
export default function ConfessionDetailClient({ code }: { code: string }) {
        ...
        <div className="flex items-center justify-between gap-3 bg-white p-3.5 sm:p-4 rounded-2xl sm:rounded-[24px] border border-slate-200/80 shadow-sm">
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-slate-500 font-sans">Anonymous campus thread — LNJPIT Chapra</p>
            </div>
          </div>
