      ...
      <header className="border-b border-slate-200/80 bg-white/90 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#FF6B00] text-white flex items-center justify-center font-black shadow-md shadow-[#FF6B00]/25">
              <ShieldAlert className="w-5 h-5 stroke-[2.5]" />
            </div>
            <div>
              <span className="font-heading font-black text-lg text-slate-950 tracking-tight">ConfessionLnjpit Admin Portal</span>
              <span className="ml-2 text-[10px] uppercase font-mono font-bold text-[#FF6B00] bg-[#FF6B00]/10 px-2 py-0.5 rounded-full border border-[#FF6B00]/20">
                Super Admin Active
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-2xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-700 text-xs font-bold border border-rose-500/20 transition-all"
            >
            ...
            <Link
              href="/feed"
              className="flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-white hover:bg-slate-100 text-xs font-bold text-slate-700 border border-slate-200 transition-all shadow-sm"
            >
